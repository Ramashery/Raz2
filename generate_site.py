...
try:
    if not firebase_admin._apps:
        ...
        # Для локального запуска можно использовать файл
        cred = credentials.Certificate('path/to/your/serviceAccountKey.json') # <-- ЗАМЕНИТЕ ПУТЬ
...
def generate_detail_page(item, all_data):
    ...
    # Гарантируем слэш в конце для папки
...
def copy_static_assets():
    ...
    static_dirs = ['css', 'js', 'images'] # Пример
    # ... логика копирования
