...
function renderHomePage() {
    // ВАЖНО: Добавили style="opacity: 0" в JS строку, чтобы при навигации "Назад" 
    // анимация сработала так же чисто, как при первой загрузке.
...
function routeAndRender(isPopState = false) {
    ...
    if (match) {
        ...
        renderHomePage();
        // ВАЖНО: Анимация Hero запустится сама через CSS
    }
...
async function hydrateStaticPage() {
    console.log("Hydrating static page (CSS Hero)...");
    renderMenu();
    setupObservers();
