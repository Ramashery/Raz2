...
function routeAndRender(isPopState = false) {
    ...
    if (match) {
        ...
        renderHomePage();
        // Задержка не нужна, CSS сам запустит анимацию
    }
