...
// Эта функция полностью изолирована и отвечает только за логику теста.
...
// Функция для обновления видимости кнопки "прокрутить вверх"
...
function initStaticEventListeners() { 
    ...
    // Этот обработчик "слушает" клики внутри <main> и реагирует только на кнопку квиза.
    // Это безопасно и не повлияет на другие элементы.
...
async function initApp() { 
    ...
    if (isStaticPage) { 
        // ================== ИЗМЕНЕНИЯ ЗДЕСЬ ==================
        // Для статических страниц по умолчанию считаем их детальными, если нет других указаний
